		    ...
		    <tbody>
		      <?php
		        ...
		        $result = mysqli_query($koneksi,"SELECT * FROM proker as a
		        					   ...
		        					   ON a.OrmawaID = b.OrmawaID WHERE PimpinanID='$PimpinanID' AND DATE_FORMAT(TanggalPelaksanaan,'%m')='$bulan' AND DATE_FORMAT(TanggalPelaksanaan,'%Y')='$tahun' AND a.NA='A'"); 
