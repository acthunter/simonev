...
<div class="col-lg-12">
    <div class="panel panel-color panel-success">
     ...
     <tr>
                 <th width="95" scope="col"><img src="./img/upi-copy.jpg" width="191" height="106" /></th>
...
<div align="center">
<p><h3> Laporan Proker Perbulan</h3></p>
...
$sql = "SELECT * FROM proker WHERE DATE_FORMAT(TanggalPelaksanaan,'%m')='$bulan' AND DATE_FORMAT(TanggalPelaksanaan,'%Y')='$tahun'";
...
<table id="" class="table table-striped table-bordered">
		    ...
		    <tbody>
		      <?php
		        ...
		        $result = mysqli_query($koneksi,"SELECT * FROM proker as a
		        					   ...
		        					   ON a.OrmawaID = b.OrmawaID WHERE DATE_FORMAT(TanggalPelaksanaan,'%m')='$bulan' AND DATE_FORMAT(TanggalPelaksanaan,'%Y')='$tahun' AND a.NA='A'"); 
		...
		</table> <input type="submit" name="proses" onclick="window.print();" class="noprint" id="proses" value="Print">
  </div>
     </div>
</div>